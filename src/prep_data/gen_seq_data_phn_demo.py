...
# tr_feat = load_feat('../../data/raw_kaldi_gop/mydataset/gopt_feats/tr_feats.csv')
# tr_keys = load_keys('../../data/raw_kaldi_gop/mydataset/gopt_feats/tr_keys_phn.csv')
tr_label = load_label('../../data/raw_kaldi_gop/mydataset/gopt_feats/tr_labels_phn.csv')
phn_dict = gen_phn_dict(tr_label)
# print(phn_dict)
# tr_feat, tr_label = process_feat_seq(tr_feat, tr_keys, tr_label, phn_dict)
# print(tr_feat.shape)
# print(tr_label.shape)
# np.save('../../data/seq_data_mydataset/tr_feat.npy', tr_feat)
# np.save('../../data/seq_data_mydataset/tr_label_phn.npy', tr_label)

# generate sequence test data
te_feat = load_feat('../../data/raw_kaldi_gop/mydataset/gopt_feats/te_feats.csv')
te_keys = load_keys('../../data/raw_kaldi_gop/mydataset/gopt_feats/te_keys_phn.csv')
# te_label_dict = load_label('../../data/raw_kaldi_gop/mydataset/gopt_feats/test.csv')
# phn_dict = gen_phn_dict(te_label_dict)
te_label = load_label('../../data/raw_kaldi_gop/mydataset/gopt_feats/te_labels_phn.csv')
